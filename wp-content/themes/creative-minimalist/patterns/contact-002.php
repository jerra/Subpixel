...
/**
 * Title: Contact 002
 * Slug: creative-minimalist/contact-002
 * Categories: contact
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-superbfont-small-font-size"><?php echo esc_html__( 'Visit us', 'creative-minimalist' ); ?>
</h3>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","textColor":"contrast","fontSize":"superbfont-xlarge"} -->
<h2 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xlarge-font-size"><?php echo esc_html__( 'Locate Us on the Map', 'creative-minimalist' ); ?>
</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"mono-2","fontSize":"superbfont-small"} -->
<p class="has-text-align-center has-mono-2-color has-text-color has-superbfont-small-font-size"><?php echo esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue lorem ut volutpat efficitur. Fusce justo magna, condimentum nec elementum sed.', 'creative-minimalist' ); ?>
</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
