...
require get_template_directory() . '/inc/customizer/front-page-options/custom-html.php';
require get_template_directory() . '/inc/customizer/front-page-options/shortcode.php';
