...
function jason_portfolio_resume_is_custom_html_section_enabled($control) {
    return ( $control->manager->get_setting( 'jason_portfolio_resume_enable_custom_html_section' )->value() );
}
function jason_portfolio_resume_is_shortcode_section_enabled($control) {
    return ( $control->manager->get_setting( 'jason_portfolio_resume_enable_shortcode_section' )->value() );
}