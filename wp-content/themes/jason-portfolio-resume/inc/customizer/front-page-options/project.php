...
$themes = json_decode(get_option('crt_manage_license'));
if($themes) {
    if(in_array(get_option( 'template' ), $themes)) {
...
$wp_customize->add_setting(
    'jason_portfolio_resume_project_section_id',
    array(
        'default'           => __( 'my-project', 'jason-portfolio-resume' ),
        'sanitize_callback' => 'wp_kses_post',
    )
...
$wp_customize->add_control(
    ...
    array(
        ...
        'section'         => 'jason_portfolio_resume_project_section',
        'settings'        => 'jason_portfolio_resume_project_section_id',
        'type'            => 'text',
        'active_callback' => 'jason_portfolio_resume_is_project_section_enabled',
    )
);
